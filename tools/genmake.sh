...
# Jerry Cooperstein, coop@linuxfoundation.org, 2/2003 - 1/2023
# License: GPLv2
...
if [[ -n $KINCS ]] ; then
	FLAGS_U_X="$CFLAGS_U_X -I$KROOT/include"
...
echo "### Copyright, Jerry Cooperstein, coop@linuxfoundation.org 2003-2023 ####" >>Makefile
